            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="aim_modell">Aim model</label>
                        <select class="" id="aim_modell" name="aim_model">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="ref_modell">Reference model</label>
                        <select class="" id="ref_modell" name="ref_model">
                            <option value="" selected>---select model---</option>
                            @foreach($cruds as $crud)
                                <option value="{{$crud->id}}">{{ $crud->model_name }}</option>
                            @endforeach
